...
const seeds: InboxSeed[] = [
   ...
   ['ADI-710', 'status', 3, 'marked this issue as blocked by ADI-707', '4h', false],
   [
      'ADI-704',
      'mention',
      4,
   ...
   ['ADI-726', 'closed', 4, 'moved this issue from In Progress to Done', '9h', false],
   [
      'ADI-701',
      'comment',
      7,
   ...
   ['ADI-736', 'created', 5, 'created this issue and added it to Cycle 21', '1d', true],
   ['ADI-715', 'assignment', 9, 'assigned this issue to you', '1d', false],
   [
      'ADI-702',
      'comment',
      13,
   ...
   ['ADI-819', 'created', 16, 'created this issue from docs feedback', '2d', true],
   ['ADI-706', 'edited', 12, 'updated the token mapping section of the description', '3d', true],
   ['ADI-735', 'closed', 3, 'moved this issue from Technical Review to Shipped', '3d', true],
   [
      'ADI-722',
      'mention',
      19,
   ...
   ['ADI-731', 'upload', 14, 'attached the search indexing benchmark results', '6d', true],
];
