         ...
         <SettingsSection>
            ...
            <SettingsCard>
               <SettingsRow
                  ...
                  description="Sync your calendar out-of-office status to Adisearch Workspace"
                  trailing={<ConnectedTrailing />}
               />
            </SettingsCard>
            <SettingsCard>
            ...
            <SettingsCard>
               ...
               <SettingsRow
                  title="octo-relay"
                  description="Review code in Adisearch Workspace and sync attribution of your git-related actions"
                  trailing={<ConnectedTrailing />}
               />
            </SettingsCard>
         </SettingsSection>
