      ...
      <div className="flex h-full w-full flex-col overflow-y-auto">
         ...
         <div className="px-5 py-4">
            ...
            <div className="mt-3 grid gap-2 text-sm">
               <Link href={`${base}/overview`} className="rounded-md border px-3 py-2 hover:bg-accent/40">
                  Overview
               </Link>
               <Link href={`${base}/issues`} className="rounded-md border px-3 py-2 hover:bg-accent/40">
                  Issues
               </Link>
               <Link href={`${base}/milestones`} className="rounded-md border px-3 py-2 hover:bg-accent/40">
                  Milestones
               </Link>
               <Link href={`${base}/activity`} className="rounded-md border px-3 py-2 hover:bg-accent/40">
                  Activity & updates
               </Link>
            </div>
            <div className="mt-4 rounded-md border border-dashed p-3 text-xs text-muted-foreground">
               ...
               <p className="mt-1">
                  Slack workspace authorization is not released yet. Manage available provider connections from Connected accounts.
               </p>
               <Link
                  href={`/${workspace.organization.slug}/settings/connected-accounts`}
