...
export function AdisearchAuthBackground() {
   return (
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
         ...
         <div className={`${styles.glow} ${styles.glowOne} absolute`} />
         <div className={`${styles.glow} ${styles.glowTwo} absolute`} />
         ...
         <div className="absolute left-1/2 top-1/2 size-[34rem] -translate-x-1/2 -translate-y-1/2 opacity-[0.13] sm:size-[42rem] lg:left-[28%] lg:size-[54rem] dark:opacity-[0.18]">
            <div
               className={`${styles.orbit} absolute inset-[15%] rounded-full border border-blue-500/35`}
            />
            <div
               className={`${styles.orbit} ${styles.orbitReverse} absolute inset-[28%] rounded-full border border-cyan-400/25`}
            />
            <Image
            ...
            />
            <span
               className={`${styles.node} absolute right-[13%] top-1/2 size-3 rounded-full border border-blue-300/60 bg-blue-500/70 shadow-[0_0_28px_rgba(37,99,235,0.75)]`}
            />
         </div>

         <div
            className={`${styles.pixels} absolute bottom-[13%] left-[7%] hidden h-24 w-36 sm:block`}
         >
